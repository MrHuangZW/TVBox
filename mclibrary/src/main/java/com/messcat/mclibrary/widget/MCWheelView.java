...
public class MCWheelView extends ScrollView {
    ...
    public MCWheelView(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray ta = context.obtainStyledAttributes(attrs, com.f1reking.wheelview.R.styleable.WheelView);
        highColor = ta.getColor(com.f1reking.wheelview.R.styleable.WheelView_highColor, 0);
        ta.recycle();
        init(context);
    }
                ...
                if (initialY - newY == 0) { // stopped
                    ...
                    if (remainder == 0) {
                        ...
                        if (remainder > itemHeight / 2) {
                            MCWheelView.this.post(new Runnable() {

                                @Override
                                public void run() {
                                    MCWheelView.this.smoothScrollTo(0, initialY
                    ...
                    initialY = getScrollY();
                    MCWheelView.this.postDelayed(scrollerTask, newCheck);
                }
            }
        };
    }
    ...
    public WheelBean getWheelBean() {
        return new WheelBean(selectedIndex, items.get(selectedIndex));
    }
    ...
    public void setSeletion(int position) {
        ...
        this.post(new Runnable() {
            ...
            @Override
            public void run() {
                MCWheelView.this.smoothScrollTo(0, p * itemHeight);
            }
        });
    }
    ...
    public class WheelBean {
        ...
        public WheelBean(int id, String context) {
            this.id = id;
            this.context = context;
        }
